  ...
  return (
    <div>
      <h2 id="address-heading">
        <Translate contentKey="noMoreWaitApp.address.home.title">Addresses</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="noMoreWaitApp.address.home.createLabel">Create new Address</Translate>
        </Link>
      </h2>
        ...
        {addressList && addressList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('address')}>
                  <Translate contentKey="noMoreWaitApp.address.address">Address</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('addressLine2')}>
                  <Translate contentKey="noMoreWaitApp.address.addressLine2">Address Line 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('postalCode')}>
                  <Translate contentKey="noMoreWaitApp.address.postalCode">Postal Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="noMoreWaitApp.address.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('stateProvince')}>
                  <Translate contentKey="noMoreWaitApp.address.stateProvince">State Province</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="noMoreWaitApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>
